...
for (const index in arrayNumber) {
    ...
    console.log(`=============Traversing of array using while loop============`);
    var arrayNumber = [22, 11, 44, 55, 77, 33];
    let index=0;
    ...
    //MERN Developer -Mongo, Express GS ,React , Node
    //MEAN Developer -Mongo, Express GS ,Angular , Node
...
console.log(`*******************************code by gajanan sir=============`);
